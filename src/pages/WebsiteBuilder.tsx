                ...
                <div style={{ padding: previewMode === 'desktop' ? '40px' : '20px 15px', position: 'relative', zIndex: 3 }}>
                  ...
                  {formData.showStats && (
                    <div className={previewMode === 'desktop' ? 'canvas-grid' : ''} style={previewMode === 'mobile' ? { marginBottom: '25px', display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '10px' } : { marginBottom: '40px' }}>
                      <div style={{ backgroundColor: formData.cardColor || primaryColor, padding: '15px', borderRadius: '12px', textAlign: 'center', color: '#090D16' }}>
                        <div className="wb-editable" contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, stat1Number: e.currentTarget.textContent || ''})} style={{ fontSize: '1.5rem', fontWeight: 800, color: '#090D16' }}>{formData.stat1Number || '50+'}</div>
                        <div className="wb-editable" contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, stat1Label: e.currentTarget.textContent || ''})} style={{ fontSize: '0.75rem', color: 'rgba(9, 13, 22, 0.7)', marginTop: '5px', fontWeight: 600 }}>{formData.stat1Label || 'Vehículos Premium'}</div>
                      </div>
                      <div style={{ backgroundColor: formData.cardColor || primaryColor, padding: '15px', borderRadius: '12px', textAlign: 'center', color: '#090D16' }}>
                        <div className="wb-editable" contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, stat2Number: e.currentTarget.textContent || ''})} style={{ fontSize: '1.5rem', fontWeight: 800, color: '#090D16' }}>{formData.stat2Number || '10k+'}</div>
                        <div className="wb-editable" contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, stat2Label: e.currentTarget.textContent || ''})} style={{ fontSize: '0.75rem', color: 'rgba(9, 13, 22, 0.7)', marginTop: '5px', fontWeight: 600 }}>{formData.stat2Label || 'Clientes Satisfechos'}</div>
                      </div>
                      <div style={{ backgroundColor: formData.cardColor || primaryColor, padding: '15px', borderRadius: '12px', textAlign: 'center', color: '#090D16', display: previewMode === 'desktop' ? 'block' : 'none' }}>
                        <div className="wb-editable" contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, stat3Number: e.currentTarget.textContent || ''})} style={{ fontSize: '1.5rem', fontWeight: 800, color: '#090D16' }}>{formData.stat3Number || '99%'}</div>
                        <div className="wb-editable" contentEditable suppressContentEditableWarning onBlur={(e) => setFormData({...formData, stat3Label: e.currentTarget.textContent || ''})} style={{ fontSize: '0.75rem', color: 'rgba(9, 13, 22, 0.7)', marginTop: '5px', fontWeight: 600 }}>{formData.stat3Label || 'Valoración Positiva'}</div>
                      </div>
                    </div>
                  )}
